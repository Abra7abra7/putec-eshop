-- Migration: Fix tasting session times v2
-- Date: 2025-08-24

-- Drop existing function and recreate with explicit time handling
      ...
      LOOP
        ...
        LOOP
          ...
          VALUES (
            ...
            (session_date || ' ' || session_time_str || ':00' || ' + ' || package_record.duration_minutes || ' minutes')::timestamp with time zone,
